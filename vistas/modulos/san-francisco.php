...
<div class="problematicaYSolucion">
	...
	<div class="contenedorProblematicaYSolucion">
		<div class="contenedorImagenProblematicaYSolucion">
			<img src="<?php echo $url; ?>complementos/img/productos/sfc/robo.png" width="100%" height="100%" />
		</div>
...
<div class="problematicaYSolucion">
	...
	<div class="contenedorProblematicaYSolucion">
		...
		<div class="contenedorImagenProblematicaYSolucion">
			<img src="<?php echo $url; ?>complementos/img/productos/sfc/solucion.png" width="100%" height="90%" />
		</div>
	</div>
</div>
...
<div class="contenedorDescripcionJuego">
	...
	<div class="contenedorPartesJuego">
		<div class="contenedorImagen">
			<img src="<?php echo $url; ?>complementos/img/productos/sfc/tablero.jpeg" width="100%" height="100%" />
		</div>
	...
	<div class="contenedorPartesJuego">
		...
		<div class="contenedorImagen">
			<img src="<?php echo $url; ?>complementos/img/productos/sfc/fichas.jpeg" width="100%" height="100%" />
		</div>
	</div>

	<div class="contenedorPartesJuego">
		<div class="contenedorImagen">
			<img src="<?php echo $url; ?>complementos/img/productos/sfc/dados.jpeg" width="100%" height="100%" />
		</div>
